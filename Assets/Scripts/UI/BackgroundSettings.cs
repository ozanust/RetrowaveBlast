...
public class BackgroundSettings : MonoBehaviour
{
    ...
    [SerializeField]
    private UnlockableBackground m_activeBackground;
    ...
    public UnlockableBackground ActiveBackgroundButton
    {
        get { return m_activeBackground; }
        set { m_activeBackground = value; }
    }
